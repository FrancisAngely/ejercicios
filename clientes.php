        ...
        <table class="table">
          ...
          ?>
              <tr>
                ...
                <td><a href="clientes_edit.php?id=<?php echo $fila["id"]; ?>"><i class="fa-solid fa-marker"></i></a>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="clientes_delete.php?id=<?php echo $fila["id"]; ?>"><i class="fa-solid fa-trash-can"></i></a>
                </td>
              </tr>
          <?php
            }
